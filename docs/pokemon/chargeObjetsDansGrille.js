...
//-------------------Objets
	...
	dresseur1 = new Dresseur("Mathias",-7,-60,0,0,0);
	dresseur1.setGTX(3);
	dresseur1.setGTY(3);
	dresseur1.setTexture(document.getElementById('dresseurRougeChatain'));
	...
	dresseur2 = new Dresseur("Quentin",225,-22,1,0);
	dresseur2.setGTX(3);
	dresseur2.setGTY(5);
	...
	dresseur3 = new Dresseur("Billy",196,172,2,0);
	dresseur3.setGTX(3);
	dresseur3.setGTY(4);
	...
	dresseur4 = new Dresseur("Theo",350,18,0,0);
	dresseur4.setGTX(0);
	dresseur4.setGTY(0);
	...
	dresseur5 = new Dresseur("Leo",650,194,0,0);
	dresseur5.setGTX(0);
	dresseur5.setGTY(6);
	...
	dresseur6 = new Dresseur("Spyros",-34,110,2,0);
	dresseur6.setGTX(2);
	dresseur6.setGTY(9);
	...
	teamR2 = new Dresseur("Bad Guy2",740,20,3,0);
	...
	teamR3 = new Dresseur("Bad Guy3",844,76,2,0);
	...
	teamR4 = new Dresseur("Bad Guy4",1008,54,3,0);
	...
	teamR5 = new Dresseur("Capitaine Rocket",1076,24,1,0);
	teamR5.setGTX(9);
	teamR5.setGTY(9);
	...
	batiment1 = new Batiment("Centre Pokemon",document.getElementById("centreP"), -102,-40,120,100);
...
// All the data where generated using the "z" or "h" shortcut while playing, and copy-pasted here as it (this tool define where objects are based on the player position)
...
grille.ajouteObjet(new Objet("Collision",468,182,26,4));
	...
	grille.ajouteObjet(new Objet("Arbre",-50,4,68,46));
	grille.ajouteObjet(new Objet("Arbre",-112,-92,350,28));
	grille.ajouteObjet(new Objet("Arbre",-30,-44,12,14));
	grille.ajouteObjet(new Objet("Arbre",64,-16,14,30));
	grille.ajouteObjet(new Objet("Arbre",2,52,12,12));
	grille.ajouteObjet(new Objet("Arbre",20,38,22,38));
	grille.ajouteObjet(new Objet("Arbre",64,62,32,30));
	grille.ajouteObjet(new Objet("Arbre",-112,40,32,36));
	grille.ajouteObjet(new Objet("Arbre",-112,86,30,96));
	grille.ajouteObjet(new Objet("Arbre",-110,182,92,42));
	grille.ajouteObjet(new Objet("Arbre",-78,178,2,4));
	grille.ajouteObjet(new Objet("Arbre",-48,112,14,28));
	grille.ajouteObjet(new Objet("Arbre",-32,130,14,26));
	grille.ajouteObjet(new Objet("Arbre",-16,118,64,38));
	grille.ajouteObjet(new Objet("Arbre",46,146,34,28));
	grille.ajouteObjet(new Objet("Arbre",82,150,60,76));
	grille.ajouteObjet(new Objet("Arbre",142,184,64,42));
	grille.ajouteObjet(new Objet("Arbre",38,38,8,38));
	grille.ajouteObjet(new Objet("Arbre",96,48,14,28));
	grille.ajouteObjet(new Objet("Arbre",96,96,14,28));
	grille.ajouteObjet(new Objet("Arbre",130,116,12,12));
	grille.ajouteObjet(new Objet("Arbre",130,68,28,42));
	grille.ajouteObjet(new Objet("Arbre",192,70,28,38));
	grille.ajouteObjet(new Objet("Arbre",238,-66,34,256));
...
var chargeObjetsDansGrille1 = function(grille){//-------------------------------------------------------------------------------------------
		...
		//grille.ajoutePorte( new Porte(820,756,0,0,"foret1"));
